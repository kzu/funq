...
namespace Funq
{
    ...
    public sealed partial class Container : IDisposable
    {
        ...
        ServiceEntry<TService, TFunc> RegisterImpl<TService, TFunc>(string name, TFunc factory)
        {
        ...
        TService ResolveImpl<TService>(string name, bool throwIfMissing)
        {
        ...
        TService ResolveImpl<TService, TArg>(string name, bool throwIfMissing, TArg arg)
        {
            // Would throw if missing as appropriate.
        ...
        ServiceEntry<TService, TFunc> GetEntry<TService, TFunc>(string serviceName, bool throwIfMissing)
        {
        ...
        static TService ThrowMissing<TService>(string serviceName)
        {
            if (serviceName == null)
        ...
        void ThrowIfNotRegistered<TService, TFunc>(string name)
        {
