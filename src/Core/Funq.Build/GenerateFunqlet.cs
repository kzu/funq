...
namespace Funq.Build
{
    ...
    public class GenerateFunqlet : AppDomainIsolatedTask
    {
        ...
        IEnumerable<Export> BuildExports(IEnumerable<Type> exportedTypes)
        {
        ...
        static bool HasNoDefaultConstructor(Type type)
        {
            return type.GetConstructor(new Type[0]) == null;
        }

        IEnumerable<PropertyImport> BuildProperties(Type type)
        {
        ...
        IEnumerable<Import> BuildParameters(ConstructorInfo ctor)
        {
